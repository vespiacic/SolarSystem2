...
sim_start_date = "2021-04-01"  # simulating a solar system starting from this date
fpd=6 # frames per day
sim_duration = 29*fpd  #2 * 365                # (int) simulation duration in days
...
corpo=[[1, 2, 3, 4, -96, -144, -37, -121, -64,
     -234],['Mercurio', 'Venere: Akatsuki', 'L1: 5 missioni\nLuna: 5 missioni\nL2: 2 missioni', 'Marte: 11 missioni',
...
ani.save('solarsystemHD.mp4', writer=writervideo) #output mp4 file